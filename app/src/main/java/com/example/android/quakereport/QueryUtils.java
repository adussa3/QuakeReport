...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                // Get a single earthquake at position i within th elsit of earthquakes
                JSONObject earthquakeJson = earthquakeArray.getJSONObject(i);
    ...
    /**
     * Format the magnitude of the earthquake to one decimal point
     *
     * @param mag is the magnitude of the earthquake
     * @return the formatted magnitude of the earthquake
     */
